...
Zur Information für Neugierige: Im Workshop werden wir zwei Raspberry Pi Picos verwenden. Einer wird als 'Debug-Probe' und der andere als 'Target' verwendet (näheres unter ["Debug Probe"](./debugprobe.md)). Obwohl die Entwicklung ohne eine Debug-Probe möglich ist, kann sie mit der Zeit umständlich werden, da der Pico vor jedem Flash-Vorgang immer wieder in den BOOTSEL-Modus versetzt werden muss.
